...
class BaseFileHelper
{
     ...
     * whose name is the same as the language code. For example, given the file "path/to/stat.php"
     * and language code "zh-CN", the localized file will be looked for as
     * "path/to/zh-CN/stat.php". If the file is not found, it will try a fallback with just a language code that is
     * "zh" i.e. "path/to/zh/stat.php". If it is not found as well the original file will be returned.
     *
