...
<p>
    ...
    <?= Html::a('Управление категориями', ['/newscategory/index'], ['class' => 'btn btn-default']) ?>
...
$categories =  NewsCategory::find()->where(['id_company' => [Yii::$app->user->identity->id_company]])->select(['id','title'])->all();
