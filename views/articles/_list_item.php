            ...
            <ul class="timeline">
                ...
                <li>
                    ...
                    <div class="timeline-item">
                        <span class="time"> <i class="pl-10 fa fa-tags"></i><a href=" ?id_category=<?=$model->category?>"><?= \app\controllers\CategoryController::categoryTypeName($model->category) ?></a></span>
